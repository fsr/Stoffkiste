...
\begin{description}
    ...
    Cut-through Switch: $t_{ges}=t_f+n\cdot\frac{14\cdot8}{b} \hspace{1cm}t_f=\frac{(F+26)\cdot8}{b}$\hspace{1cm}$n=$Anzahl Switches \\
    Präambel + Zieladresse = 14 Byte ~Quelladresse + EtherType/Size + CRC = 12 Byte
\end{description}
